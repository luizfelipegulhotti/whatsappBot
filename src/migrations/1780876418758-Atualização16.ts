...
export class Atualização161780876418758 implements MigrationInterface {
    name = 'Atualização161780876418758'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`motorista\` ADD \`podeFazerRota\` tinyint NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`motorista\` DROP COLUMN \`podeFazerRota\``);
    }
