...
export class Atualização191781037787457 implements MigrationInterface {
    name = 'Atualização191781037787457'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`administrador\` ADD \`whatsappLid\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`administrador\` ADD UNIQUE INDEX \`IDX_7c87ca814dd62a5a751452d7b3\` (\`whatsappLid\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`administrador\` DROP INDEX \`IDX_7c87ca814dd62a5a751452d7b3\``);
        await queryRunner.query(`ALTER TABLE \`administrador\` DROP COLUMN \`whatsappLid\``);
    }
