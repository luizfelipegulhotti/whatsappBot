...
export class Atualização181780884606443 implements MigrationInterface {
    name = 'Atualização181780884606443'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` ADD \`isApoioManual\` tinyint NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` DROP COLUMN \`isApoioManual\``);
    }
