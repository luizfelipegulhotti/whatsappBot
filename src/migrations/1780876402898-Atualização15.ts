...
export class Atualização151780876402898 implements MigrationInterface {
    name = 'Atualização151780876402898'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` CHANGE \`posicaoEfetiva\` \`posicaoEfetiva\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` CHANGE \`posicaoEfetiva\` \`posicaoEfetiva\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_1f5c02202890ba278424c71b04\` ON \`ordem_joinha\` (\`motoristaId\`, \`listaJoiaId\`)`);
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` ADD CONSTRAINT \`FK_72929c3d4fb0023036109b3cef0\` FOREIGN KEY (\`motoristaId\`) REFERENCES \`motorista\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
