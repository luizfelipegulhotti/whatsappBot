...
export class Atualização141780801706258 implements MigrationInterface {
    name = 'Atualização141780801706258'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`motorista\` CHANGE \`telefoneWhatsApp\` \`telefoneWhatsApp\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`motorista\` CHANGE \`whatsAppLid\` \`whatsAppLid\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`empresa\` CHANGE \`icone\` \`icone\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` CHANGE \`horaDoJoinha\` \`horaDoJoinha\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_1f5c02202890ba278424c71b04\` ON \`ordem_joinha\` (\`motoristaId\`, \`listaJoiaId\`)`);
        ...
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_825f9e5534f420ae68d98e5d169\` FOREIGN KEY (\`motoristaId\`) REFERENCES \`motorista\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_53c2c6fb8670e0bcbd0dcb7c1f7\` FOREIGN KEY (\`listaJoiaId\`) REFERENCES \`lista_joia\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_382edab62a0ad165bcbeec96c68\` FOREIGN KEY (\`listaRotaId\`) REFERENCES \`lista_rota\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_6427001841eb49957c4c7d8641b\` FOREIGN KEY (\`rotaId\`) REFERENCES \`rota\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` DROP FOREIGN KEY \`FK_72929c3d4fb0023036109b3cef0\``);
        await queryRunner.query(`ALTER TABLE \`rota\` DROP FOREIGN KEY \`FK_36b21dafdfbe458db0b545b3074\``);
        await queryRunner.query(`DROP INDEX \`IDX_1f5c02202890ba278424c71b04\` ON \`ordem_joinha\``);
        ...
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_53c2c6fb8670e0bcbd0dcb7c1f7\` FOREIGN KEY (\`listaJoiaId\`) REFERENCES \`lista_joia\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_825f9e5534f420ae68d98e5d169\` FOREIGN KEY (\`motoristaId\`) REFERENCES \`motorista\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` CHANGE \`horaDoJoinha\` \`horaDoJoinha\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(3)`);
        ...
        await queryRunner.query(`ALTER TABLE \`rota\` ADD CONSTRAINT \`FK_36b21dafdfbe458db0b545b3074\` FOREIGN KEY (\`listaRotaId\`) REFERENCES \`lista_rota\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`empresa\` CHANGE \`icone\` \`icone\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`motorista\` CHANGE \`dataDeEdicao\` \`dataDeEdicao\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`motorista\` CHANGE \`dataDeRegistro\` \`dataDeRegistro\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`motorista\` CHANGE \`whatsAppLid\` \`whatsAppLid\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`motorista\` CHANGE \`telefoneWhatsApp\` \`telefoneWhatsApp\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`usuario\` CHANGE \`dataDeEdicao\` \`dataDeEdicao\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`usuario\` CHANGE \`dataDeRegistro\` \`dataDeRegistro\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`administrador\` CHANGE \`dataDeEdicao\` \`dataDeEdicao\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`administrador\` CHANGE \`dataDeRegistro\` \`dataDeRegistro\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
